      ...
      <div className="relative w-full max-w-xl bg-white rounded-[32px] border-4 border-[#111111] shadow-[0_12px_0_#FF3B30] overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-4 flex-1">
          ...
          {activeOrder.paymentProofUrl && (
            <div className="p-3 bg-[#FFF8F2] rounded-2xl border-2 border-[#111111] flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5">
                <div className="w-12 h-12 rounded-xl overflow-hidden border border-[#111111] bg-white shrink-0">
                ...
                <div>
                  ...
                  <span className="text-[10px] font-bold text-[#6B6B6B]">
                    Tap to verify transaction reference
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                className="tactile-btn px-3 py-1.5 text-xs font-black bg-white text-[#111111] flex items-center gap-1"
              >
